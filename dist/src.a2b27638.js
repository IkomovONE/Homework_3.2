      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 10:
            ...
            _context.next = 13;
            return Fetched2.json();

          case 13:
            EmploymentData = _context.sent;
            console.log(EmploymentData);
            label = CountryData.dataset.dimension.Alue.category.label;
            values = CountryData.dataset.value;
            Employment = EmploymentData.dataset.value;

            for (i = 0; i < Object.values(label).length; i++) {
